...
Another way to do it is to initiate a new repository in the `CataloguePlugins/YourPluginName` folder. This might be preferable as you can push updates from inside your development environment without first copying the files outside of it.
